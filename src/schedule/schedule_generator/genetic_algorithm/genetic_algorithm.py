...
from src.schedule.schedule_generator.genetic_algorithm import Individual as _Individual, mutation
from src.schedule.schedule_generator.schedule import Schedule
